...
def archivo ():
    ...
    preca.pack()
    Label(menu_arch,title="temperatura 1").pack(anchor=NW)
    temp1 = Entry(menu_arch)
    temp1.pack()
    Label(menu_arch,title="temperatura 2").pack(anchor=NW)
    temp2 = Entry(menu_arch)
    temp2.pack()
    Label(menu_arch,title="temperatura 3").pack(anchor=NW)
    temp3 = Entry(menu_arch)
    temp3.pack()
    Label(menu_arch,title="temperatura 4").pack(anchor=NW)
